function toggleMusic() {
  ...
  if (music.paused) {
    music.play();
    button.textContent = "Pause Romantic Music 🎶";
  } else {
    music.pause();
...
// Countdown timer
const birthday = new Date("2025-08-27T00:00:00").getTime();
function updateCountdown() {
  ...
  if (distance > 0) {
    ...
    countdownElement.innerHTML = `${days}d ${hours}h ${minutes}m ${seconds}s until your epic birthday! 🎂`;
  } else {
...
// Fireworks animation (adapted from open-source example)
